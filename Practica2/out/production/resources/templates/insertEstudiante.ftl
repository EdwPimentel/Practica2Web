...
<nav >
    <div >
        <div >
            <ul style="list-style-type: none; margin: 0; padding: 0; overflow: hidden; background-color: darkolivegreen;">
                <li style="float: left; font-family: Arial;">
                    <a  href="/" style="display: block; color: forestgreen; text-align: center; padding: 14px 16px; text-decoration: none;">Inicio</a>
                </li>
            </ul>
        </div>
    </div>
